...
private:
	...
	cocos2d::RenderTexture* lightAreaMap;
	cocos2d::Sprite* lightAreaMapSprite;
	cocos2d::RenderTexture* finalAreaMap;
	cocos2d::Sprite* finalAreaMapSprite;
	cocos2d::backend::Program* lightRenderShader;
	cocos2d::backend::ProgramState* lightRenderShaderState;

	void initDarkAreaMap();
	void createDarkAreaMap();

	void initLightAreaMap();
	void initFinalAreaMap();
	void updateUniforms();
	void createLightAreaMap();
	void createFinalAreaMap();
public:
	...
	void addLightSource(const cocos2d::Point& position, int size, cocos2d::Sprite* lightCircle, std::string name);
